...
to setup-world
  ...
  ask patches with [ pxcor = -3 and pycor = 5 ] [ set-corridor "c1" "c1" ]
  ask patches with [ pxcor = -5 and pycor = 3 ] [ set-corridor "c2" "c2" ]
  ask patches with [ pxcor = -1 and pycor = 3 ] [ set-corridor "c3" "c3" ]
  ask patches with [ pxcor = -3 and pycor = 1 ] [ set-corridor "c4" "c4" ]
  ask patches with [ pxcor = 1 and pycor = 1 ] [ set-corridor "c5" "c5" ]
  ask patches with [ pxcor = -1 and pycor = -1 ] [ set-corridor "c6" "c6" ]
  ask patches with [ pxcor = 3 and pycor = -1 ] [ set-corridor "c7" "c7" ]
  ask patches with [ pxcor = 1 and pycor = -3 ] [ set-corridor "c8" "c8" ]
...
to set-corridor [ patch-name patch-label ]
  set name patch-name
  set pcolor white
  set plabel patch-label
